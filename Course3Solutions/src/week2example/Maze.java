...
public class Maze 
{
	...
	/** Link the nodes that are adjacent (and not null) to each 
	 * other with an edge.  There is an edge between any two adjacent nodes
	...
	private List<MazeNode> getNeighbors(int row, int col) 
	{
		MazeNode n = cells[row][col];
